...
const {mutation: mutationOptions} = options ?
 ...
 signal?: AbortSignal
      ...
      return axiosInstance<void>(
      {url: `/api/Auth/register-gym`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: gymSignupRequest, signal
    },
      );
    }
...
export const getRegisterGymMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof registerGym>>, TError,{data?: GymSignupRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof registerGym>>, TError,{data?: GymSignupRequest}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof registerGym>>, {data?: GymSignupRequest}> = (props) => {
          const {data} = props ?? {};

          return  registerGym(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RegisterGymMutationResult = NonNullable<Awaited<ReturnType<typeof registerGym>>>
    export type RegisterGymMutationBody = GymSignupRequest | undefined
    export type RegisterGymMutationError = unknown

    export const useRegisterGym = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof registerGym>>, TError,{data?: GymSignupRequest}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof registerGym>>,
        TError,
        {data?: GymSignupRequest},
        TContext
      > => {
      return useMutation(getRegisterGymMutationOptions(options), queryClient);
    }
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RefreshMutationBody = RefreshTokenRequest | undefined
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type LogoutMutationBody = RefreshTokenRequest | undefined
