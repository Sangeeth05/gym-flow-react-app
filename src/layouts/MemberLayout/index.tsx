...
const navItems = [
  ...
  { path: '/member/attendance', label: 'Attendance' },
  { path: '/member/workout-plan', label: 'Workout Plan' },
  { path: '/member/progress', label: 'Progress' },
  { path: '/member/payments', label: 'Payments' },
  { path: '/member/trainer', label: 'My Trainer' },
      ...
      <aside className="fixed left-0 top-0 h-full w-60 bg-dark-800 border-r border-dark-600 z-40 flex flex-col">
        <div className="flex items-center gap-3 px-4 py-5 border-b border-dark-600">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Member Portal</p>
          </div>
        </div>
